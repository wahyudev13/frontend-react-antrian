                    ...
                    <Col>
                        <Card className="text-center card-nomor">
                            ...
                            <Card.Body>
                                ...
                                <Card.Title className="no-antrian-mod2">{nomord}</Card.Title>
                            </Card.Body>
                    ...
                    <Col>
                        <Card className="text-center card-nomor">
                            ...
                            <Card.Body>
                                ...
                                <Card.Title className="no-antrian-mod2">{nomore}</Card.Title>
                            </Card.Body>
                    ...
                    <Col>
                        <Card className="text-center card-nomor">
                            ...
                            <Card.Body>
                                ...
                                <Card.Title className="no-antrian-mod2">{nomorf}</Card.Title>
                            </Card.Body>
