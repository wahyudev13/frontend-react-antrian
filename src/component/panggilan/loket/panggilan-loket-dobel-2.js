...
function PanggilanLoket2() {
    ...
    const panggilAntrian = async () => {
        if (namaPoli !== '') {
            try {
                await axios.post(`${host}/api/loket/dobel-2/panggil`, {
                    nomor: noAntrian,
                    namapoli: namaPoli
                }).then(function (res) {
                ...
                //await axios.post(`${host}/api/loket/dobel-1/panggil/${noAntrian}/${namaPoli}`);
            } catch (error) {
            ...
            <div className="row">
                ...
                <div className="col-md-12" style={{ textAlign: '-webkit-center' }}>
                    ...
                    <div className="card" style={{ maxWidth: '30rem', marginBottom: '20px' }}>
                        <div className="card-header text-center text-bg-danger" style={{ fontSize: '20px' }}>
                            Antrian Pendaftaran Loket 2
                        </div>
...
export default PanggilanLoket2;